(function() {
	...
	var VersionsTabView = OCA.Files.DetailTabView.extend(
		...
		initialize: function() {
			...
			this.collection = new OCA.EosVersions.VersionCollection();
		...
		getLabel: function() {
			return t('files_eosversions', 'Versions');
		},
		...
		_formatItem: function(version) {
			...
			return _.extend({
				...
				revertLabel: t('files_eosversions', 'Restore'),
		...
		render: function() {
			this.$el.html(this.template({
				emptyResultLabel: t('files_eosversions', 'No other versions available'),
				moreVersionsLabel: t('files_eosversions', 'More versions...')
			}));
	...
	OCA.EosVersions.VersionsTabView = VersionsTabView;
})();
